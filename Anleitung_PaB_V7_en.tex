	...
	\usepackage{titlesec} 						% individual headlines
		...
		\titleclass{\instsubtitle}{straight}[\subsection]  % subtitle
		  \titleformat{\instsubtitle}{\normalfont\small\bfseries\MakeUppercase}{}{}{}
			\titlespacing*{\instsubtitle}{0pt}{5ex}{1.5ex}	
...
\afterpage{%
 \newgeometry{left=2cm,right=2cm,top=3.5cm}
  \begin{figure}[ht!] 
	\begin{minipage}[t]{1\linewidth} 
		\begin{tcolorbox}[arc=0pt,colframe=black!25]
			...
			\textbf{\underline{General}} ~\bigbreak

				\begin{tabular}{ll}
					\textbf{Rounds} 				& 40 rounds (rounds \hspace{0.06cm} 1 - 10: procurement procedure 1,\\
													& \hspace{1.8cm} rounds 11 - 20: procurement procedure 2, \\
													& \hspace{1.8cm} rounds 21 - 30: procurement procedure 1, \\  \medbreak
													& \hspace{1.8cm} rounds 31 - 40: procurement procedure 2) \\ \medbreak
					\textbf{Groups} 				& groups of three (randomly formed every round) \\ 
					\textbf{Production Costs} 		& random whole number between 100 and 199 (individual, and   \\ \medbreak
													& for every participant in each round randomly determined)  \\ \medbreak
					\textbf{Geldeinheiten (GE)} 	& 20 GE corresponds to 1 Euro, i.e. 1 GE corresponds to 0.05 Euro \\
					\textbf{Your Payment} 			& 10 Euros show-up fee plus your profit in 16 randomly chosen rounds \\
					\hspace{3.75cm}					& 	   \\					
				\end{tabular} ~\bigbreak
			
			\textbf{\underline{Procurement Procedure 1}} ~\bigbreak

				\begin{tabular}{ll} \medbreak
					\textbf{Bid Offer} 				& one bid offer \\ \medbreak
					\textbf{Accepted Offers} 		& 2 out of 3 offers with the lowest bid offers \\ 
					\textbf{Sales Price} 			& If your offer is accepted: \\  \medbreak
